...
async function starts() {
	...
	client.on('message-new', async (mek) => {
		try {
			...
			const ownerNumber = ["6282123952125@s.whatsapp.net"] // 
			const adminbotnumber = ["6282123952125@s.whatsapp.net"] // 
			...
			case 'owner':
				...
				case 'fake':          
                    ...
                    break
                case 'fakereplay':
                   client.reply(from, 'ange mas', 'mending lari', "0851-58533202")
                   break
                case 'but':
               ...
               client.reply(from, `Waalaikumsalam ${pushname}:)`)
                ...
                case 'donasi':
				case 'donate':
					client.sendMessage(from, 'Mau donasi ya om?✨\n\n Donasi Seiklasnya Aja Im/Tante >_< _\n\n*Pulsa TSEL :* _0821-2395-2125_\n*Dana :* _0821-2395-2125_\n*Gopay :* _0821-2395-2125_\n*OVO :* _0821-2395-2125_', text, { quoted: mek })
					break
                case 'tes':
                ...
                case 'report':
                    ...
                    client.sendMessage('6282123952125@s.whatsapp.net', options, text, {quoted: mek})
